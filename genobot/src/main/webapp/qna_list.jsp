        ...
        <div class="container">
          ...
          <div class="d-flex justify-content-between mt-4 mb-2">
            <div class="btn-wrap btn-status">
              <button type="button" class="btn btn-secondary btn-sm selected">전체</button>
              <button type="button" class="btn btn-secondary btn-sm">상담대기</button>
              <button type="button" class="btn btn-secondary btn-sm">상담중</button>
              <button type="button" class="btn btn-secondary btn-sm">상담완료</button>
            </div>
            <!-- 검색 -->
